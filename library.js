...
library.init = function(params, callback) {
	...
	app.get('/admin/plugins/rehau', middleware.admin.buildHeader, renderAdmin);
	app.get('/api/admin/plugins/rehau', renderAdmin);
...
library.getThemeConfig = function(config, callback) {
	...
	meta.settings.get('rehau', function(err, settings) {
...
function renderAdmin(req, res, next) {
	res.render('admin/plugins/rehau', {});
}
